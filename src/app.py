...
def get_DataCountry( country_name ):
    """
    It takes a country name as a string, and returns a list of dictionaries, each dictionary containing
    information about a country with that name
    
    :param country: The name of the country you want to get data from
...
def add_countryRow_to_dataFrame( country_name, df ):
    ...
    country_row = generate_countryRow( country_name )
    if country_row!=None:
